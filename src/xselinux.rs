...
impl_reply_cookie!(QueryVersionCookie<'s>, mk_reply_xcb_selinux_query_version_reply_t, QueryVersionReply, xcb_selinux_query_version_reply);
...
pub struct GetDeviceCreateContextReply { base:  base::Reply<xcb_selinux_get_device_create_context_reply_t> }
fn mk_reply_xcb_selinux_get_device_create_context_reply_t(reply:*mut xcb_selinux_get_device_create_context_reply_t) -> GetDeviceCreateContextReply { GetDeviceCreateContextReply { base : base::mk_reply(reply) } }
...
impl_reply_cookie!(GetDeviceCreateContextCookie<'s>, mk_reply_xcb_selinux_get_device_create_context_reply_t, GetDeviceCreateContextReply, xcb_selinux_get_device_create_context_reply);
...
pub struct GetDeviceContextReply { base:  base::Reply<xcb_selinux_get_device_context_reply_t> }
fn mk_reply_xcb_selinux_get_device_context_reply_t(reply:*mut xcb_selinux_get_device_context_reply_t) -> GetDeviceContextReply { GetDeviceContextReply { base : base::mk_reply(reply) } }
...
impl_reply_cookie!(GetDeviceContextCookie<'s>, mk_reply_xcb_selinux_get_device_context_reply_t, GetDeviceContextReply, xcb_selinux_get_device_context_reply);
...
pub struct GetWindowCreateContextReply { base:  base::Reply<xcb_selinux_get_window_create_context_reply_t> }
fn mk_reply_xcb_selinux_get_window_create_context_reply_t(reply:*mut xcb_selinux_get_window_create_context_reply_t) -> GetWindowCreateContextReply { GetWindowCreateContextReply { base : base::mk_reply(reply) } }
...
impl_reply_cookie!(GetWindowCreateContextCookie<'s>, mk_reply_xcb_selinux_get_window_create_context_reply_t, GetWindowCreateContextReply, xcb_selinux_get_window_create_context_reply);

pub struct GetWindowContextReply { base:  base::Reply<xcb_selinux_get_window_context_reply_t> }
fn mk_reply_xcb_selinux_get_window_context_reply_t(reply:*mut xcb_selinux_get_window_context_reply_t) -> GetWindowContextReply { GetWindowContextReply { base : base::mk_reply(reply) } }
...
impl_reply_cookie!(GetWindowContextCookie<'s>, mk_reply_xcb_selinux_get_window_context_reply_t, GetWindowContextReply, xcb_selinux_get_window_context_reply);

pub struct ListItem {pub base : base::Struct<xcb_selinux_list_item_t> }
...
impl Iterator for ListItemIterator {
    ...
    fn next(&mut self) -> Option<ListItem> {
        ...
        unsafe {
            let iter: *mut xcb_selinux_list_item_iterator_t = mem::transmute(self);
            let data = (*iter).data;
...
pub struct GetPropertyCreateContextReply { base:  base::Reply<xcb_selinux_get_property_create_context_reply_t> }
fn mk_reply_xcb_selinux_get_property_create_context_reply_t(reply:*mut xcb_selinux_get_property_create_context_reply_t) -> GetPropertyCreateContextReply { GetPropertyCreateContextReply { base : base::mk_reply(reply) } }
...
impl_reply_cookie!(GetPropertyCreateContextCookie<'s>, mk_reply_xcb_selinux_get_property_create_context_reply_t, GetPropertyCreateContextReply, xcb_selinux_get_property_create_context_reply);
...
pub struct GetPropertyUseContextReply { base:  base::Reply<xcb_selinux_get_property_use_context_reply_t> }
fn mk_reply_xcb_selinux_get_property_use_context_reply_t(reply:*mut xcb_selinux_get_property_use_context_reply_t) -> GetPropertyUseContextReply { GetPropertyUseContextReply { base : base::mk_reply(reply) } }
...
impl_reply_cookie!(GetPropertyUseContextCookie<'s>, mk_reply_xcb_selinux_get_property_use_context_reply_t, GetPropertyUseContextReply, xcb_selinux_get_property_use_context_reply);

pub struct GetPropertyContextReply { base:  base::Reply<xcb_selinux_get_property_context_reply_t> }
fn mk_reply_xcb_selinux_get_property_context_reply_t(reply:*mut xcb_selinux_get_property_context_reply_t) -> GetPropertyContextReply { GetPropertyContextReply { base : base::mk_reply(reply) } }
...
impl_reply_cookie!(GetPropertyContextCookie<'s>, mk_reply_xcb_selinux_get_property_context_reply_t, GetPropertyContextReply, xcb_selinux_get_property_context_reply);

pub struct GetPropertyDataContextReply { base:  base::Reply<xcb_selinux_get_property_data_context_reply_t> }
fn mk_reply_xcb_selinux_get_property_data_context_reply_t(reply:*mut xcb_selinux_get_property_data_context_reply_t) -> GetPropertyDataContextReply { GetPropertyDataContextReply { base : base::mk_reply(reply) } }
...
impl_reply_cookie!(GetPropertyDataContextCookie<'s>, mk_reply_xcb_selinux_get_property_data_context_reply_t, GetPropertyDataContextReply, xcb_selinux_get_property_data_context_reply);

pub struct ListPropertiesReply { base:  base::Reply<xcb_selinux_list_properties_reply_t> }
fn mk_reply_xcb_selinux_list_properties_reply_t(reply:*mut xcb_selinux_list_properties_reply_t) -> ListPropertiesReply { ListPropertiesReply { base : base::mk_reply(reply) } }
...
impl_reply_cookie!(ListPropertiesCookie<'s>, mk_reply_xcb_selinux_list_properties_reply_t, ListPropertiesReply, xcb_selinux_list_properties_reply);
...
pub struct GetSelectionCreateContextReply { base:  base::Reply<xcb_selinux_get_selection_create_context_reply_t> }
fn mk_reply_xcb_selinux_get_selection_create_context_reply_t(reply:*mut xcb_selinux_get_selection_create_context_reply_t) -> GetSelectionCreateContextReply { GetSelectionCreateContextReply { base : base::mk_reply(reply) } }
...
impl_reply_cookie!(GetSelectionCreateContextCookie<'s>, mk_reply_xcb_selinux_get_selection_create_context_reply_t, GetSelectionCreateContextReply, xcb_selinux_get_selection_create_context_reply);
...
pub struct GetSelectionUseContextReply { base:  base::Reply<xcb_selinux_get_selection_use_context_reply_t> }
fn mk_reply_xcb_selinux_get_selection_use_context_reply_t(reply:*mut xcb_selinux_get_selection_use_context_reply_t) -> GetSelectionUseContextReply { GetSelectionUseContextReply { base : base::mk_reply(reply) } }
...
impl_reply_cookie!(GetSelectionUseContextCookie<'s>, mk_reply_xcb_selinux_get_selection_use_context_reply_t, GetSelectionUseContextReply, xcb_selinux_get_selection_use_context_reply);

pub struct GetSelectionContextReply { base:  base::Reply<xcb_selinux_get_selection_context_reply_t> }
fn mk_reply_xcb_selinux_get_selection_context_reply_t(reply:*mut xcb_selinux_get_selection_context_reply_t) -> GetSelectionContextReply { GetSelectionContextReply { base : base::mk_reply(reply) } }
pub fn GetSelectionContext<'r> (c : &'r Connection,
  ...
  unsafe {
    let cookie = xcb_selinux_get_selection_context(c.get_raw_conn(),
        selection as ffi::xproto::xcb_atom_t); //1
...
impl_reply_cookie!(GetSelectionContextCookie<'s>, mk_reply_xcb_selinux_get_selection_context_reply_t, GetSelectionContextReply, xcb_selinux_get_selection_context_reply);

pub struct GetSelectionDataContextReply { base:  base::Reply<xcb_selinux_get_selection_data_context_reply_t> }
fn mk_reply_xcb_selinux_get_selection_data_context_reply_t(reply:*mut xcb_selinux_get_selection_data_context_reply_t) -> GetSelectionDataContextReply { GetSelectionDataContextReply { base : base::mk_reply(reply) } }
...
impl_reply_cookie!(GetSelectionDataContextCookie<'s>, mk_reply_xcb_selinux_get_selection_data_context_reply_t, GetSelectionDataContextReply, xcb_selinux_get_selection_data_context_reply);

pub struct ListSelectionsReply { base:  base::Reply<xcb_selinux_list_selections_reply_t> }
fn mk_reply_xcb_selinux_list_selections_reply_t(reply:*mut xcb_selinux_list_selections_reply_t) -> ListSelectionsReply { ListSelectionsReply { base : base::mk_reply(reply) } }
...
impl_reply_cookie!(ListSelectionsCookie<'s>, mk_reply_xcb_selinux_list_selections_reply_t, ListSelectionsReply, xcb_selinux_list_selections_reply);

pub struct GetClientContextReply { base:  base::Reply<xcb_selinux_get_client_context_reply_t> }
fn mk_reply_xcb_selinux_get_client_context_reply_t(reply:*mut xcb_selinux_get_client_context_reply_t) -> GetClientContextReply { GetClientContextReply { base : base::mk_reply(reply) } }
...
impl_reply_cookie!(GetClientContextCookie<'s>, mk_reply_xcb_selinux_get_client_context_reply_t, GetClientContextReply, xcb_selinux_get_client_context_reply);
